...
#define STORAGE_BUFFER_SIZE 244

//the variable type is depend on the adc resolution
typedef uint8_t data_buffer_storage_t[STORAGE_BUFFER_SIZE];
...
*/
data_buffer_t* write_data_buffer(data_buffer_t* buffer, uint8_t data);
